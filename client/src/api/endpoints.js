...
export const API = {
  ...
  PUBLIC: {
    ...
    COHORTS_COMPLETED: '/public/cohorts/completed',
    COHORTS_EXISTS: '/public/cohorts/exists',
  ...
  SUPERADMIN: {
    ...
    PROGRAMMES_BULK_UPDATE: '/superadmin/programmes/bulk-update',
    PROGRAMMES_BULK_DELETE: '/superadmin/programmes/bulk',

    COHORTS: '/superadmin/cohorts',
    COHORT_BY_ID: (id) => `/superadmin/cohorts/${id}`,

    COHORTS_BULK_UPDATE: '/superadmin/cohorts/bulk-update',
    COHORTS_BULK_DELETE: '/superadmin/cohorts/bulk',
