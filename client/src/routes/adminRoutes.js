...
export const adminRoutes = [
  ...
  { id: 'admin-legal-pages', path: '/admin/legal-pages', page: 'LegalPagesList', layout: 'PanelLayout', access: 'admin', meta: { title: 'Legal Pages' } },
  { id: 'admin-legal-page-edit', path: '/admin/legal-pages/:slug/edit', page: 'LegalPageEdit', layout: 'PanelLayout', access: 'admin', meta: { title: 'Edit Legal Page' } },
