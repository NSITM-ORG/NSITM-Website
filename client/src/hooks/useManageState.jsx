...
export function useManageState() {
  ...
  const actions = useMemo(
    () => ({
      ...
      bulkUpdateProgrammes: (p) => dispatch(programmeActions.bulkUpdateProgrammes(p)).unwrap(),
      bulkDeleteProgrammes: (ids) => dispatch(programmeActions.bulkDeleteProgrammes(ids)).unwrap(),
      ...
      fetchCompletedCohorts: () => dispatch(cohortActions.fetchCompletedCohorts()).unwrap(),
      checkCohortsExist: () => dispatch(cohortActions.checkCohortsExist()).unwrap(),
      ...
      bulkUpdateCohorts: (p) => dispatch(cohortActions.bulkUpdateCohorts(p)).unwrap(),
      bulkDeleteCohorts: (ids) => dispatch(cohortActions.bulkDeleteCohorts(ids)).unwrap(),
