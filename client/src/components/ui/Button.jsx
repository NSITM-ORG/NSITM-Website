...
const VARIANT_CLASSES = {
  ...
  secondary: 'bg-secondary text-white hover:brightness-90 focus-visible:ring-secondary',
  outline:
    'bg-transparent border border-border text-text-primary hover:bg-surface focus-visible:ring-primary',
  ghost: 'bg-transparent text-text-primary hover:bg-surface focus-visible:ring-primary',
  danger: 'bg-error text-white hover:brightness-90 focus-visible:ring-error',
};
