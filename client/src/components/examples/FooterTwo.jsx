...
export function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-primary/15 bg-surface-elevated text-text-primary">
      <div className="mx-auto max-w-content px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            <h4 className="mb-6 font-heading text-lg font-extrabold text-text-primary tracking-wide">
              Quick Links
            </h4>
