...
import {
  Target, Lightbulb, TrendingUp, HelpCircle, ArrowRight, 
...
import founderImg from "../../assets/images/founder_real.jpg";
import ourStoryImg from "../../assets/images/our_story_nextserve_history.png";
...
export function AboutPage() {
  ...
  const teaserProgrammes = useMemo(() => {
    // (uses the real backend-computed score for consistency,
    // instead of a raw enrollmentCount that ignores status/price/duration):
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-content px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section className="mb-16 grid gap-8 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="leading-relaxed text-text-secondary text-base mb-4">
            ...
            <p className="leading-relaxed text-text-secondary text-base">
              Every course module was refined through real student feedback, ensuring every graduate leaves with practical capability and portfolio proof.
            </p>
          </div>
          <ImageOrPlaceholder
            alt="Nextserve training session"
            className="h-80 w-full rounded-lg lg:h-96"
            src={ourStoryImg}
            placeholderText={"Fourteen Years of Practical Excellence"}
            placeholderSubText="Est. 2012"
          />
        </section>
        ...
        <section className="mb-16 grid gap-8 lg:grid-cols-2 lg:items-center">
          <ImageOrPlaceholder
            ...
            className="order-2 h-96 w-full rounded-lg lg:order-1 lg:h-96"
            // placeholderText="ND"
            src={founderImg}
            placeholderText="Founder & Academic Director"
            placeholderSubText="Federal Poly Nekede • HND Computer Science"
          />
          <div className="order-1 lg:order-2">
            ...
            <p className="leading-relaxed text-text-secondary text-base mb-4">
              ...
              years of direct, in-person instruction.
            </p>
            <p className="leading-relaxed text-text-secondary text-base">
              That grounding in real institutional teaching, not just industry practice, is what still shapes how every Nextserve programme is structured today.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          {programmes.loading ? (
            ...
            <p className="text-sm text-text-secondary">
              Programmes will appear here shortly.
            </p>
          )}
        </section>

        {/* ── 5. How We Deliver ─────────────────────────────────── */}
        <section className="mb-16 rounded-lg border border-primary/30 bg-surface-elevated p-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <p className="text-text-secondary leading-relaxed text-justify">
              Every cohort runs on a fixed schedule with a defined start and
              end, whether delivered online or in-person. Our restructuring
              toward the Live Project Model means later-stage students work on
              real deliverables under instructor supervision — turning classroom
              learning into portfolio-ready experience before graduation.
            </p>
            <p className="text-text-secondary leading-relaxed text-justify">
              We deliberately keep cohort sizes small. Instructors know their
              students by name, not by roster number — and that's a constraint
              we protect even as we scale to reach more cities and more students
              online.
            </p>
          </div>
        </section>
      ...
      <div>
        <section className=" ">
          <section className="text-gradient-brand hover:hover-glow-primary mx-auto max-w-content px-4 sm:px-6 lg:px-8">
            {" "}
            {/* ── 6. Our Community ──────────────────────────────────── */}
            <section className="mb-16 grid gap-8  lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="leading-relaxed text-text-secondary text-justify">
                  Nextserve is more than a school. It's a community of
                  practitioners, alumni, instructors, and supporters who believe
                  in what technology education can do for Nigeria's workforce
                  and for individual lives. We occasionally bring developers
                  into our community for future Live Projects — if you're
                  interested, you'll find that option on our homepage.
                </p>
              </div>
            ...
            <section className="mb-16">
              ...
              <p className="max-w-3xl leading-relaxed text-text-secondary text-justify">
                We're in the middle of a deliberate national restructuring —
                moving from a single walk-in centre into a nationwide,
                cohort-based institution accessible to students regardless of
                location. This website, and the enrollment system behind it, is
                the infrastructure for that next chapter.
              </p>
              <p className="mt-3 flex items-center gap-1.5 text-sm text-text-secondary">
                <MapPin size={15} /> Currently expanding delivery across Nigeria
                — online-first, in-person where it counts.
              </p>
            </section>
          </section>
        </section>
      ...
      <div className="mx-auto max-w-content px-4 sm:px-6 lg:px-8">
        ...
        <section className="max-width-content rounded-lg border border-primary/40 bg-surface-elevated p-6 sm:p-8">
...
function PhilosophyBlock({ icon: Icon, title, body }) {
  return (
    <div className="flex gap-3 rounded-md border border-primary/30 bg-surface-elevated p-4">
      <Icon size={25} className="mt-0.5 shrink-0 text-primary" />
      <div>
